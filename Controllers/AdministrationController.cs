       ...
       // [Authorize(Policy ="DeleteRolePolicy")]
        public async Task<IActionResult> DeleteRole(string id)
        {
            ...
            else
            {
                ...
                {
                    logger.LogError($"Exception Occuerd :{ex}");
        ...
        public async Task<IActionResult> ManageUserClaims(string userId)
        {
            ...
            var model = new UserClaimsVeiwModel
            {
                UserId = userId
            };
        ...
        [HttpPost]
        public async Task<IActionResult> ManageUserClaims(UserClaimsVeiwModel model,string userID)
        {
